...
draft = false
title = 'On Weeds'
categories = ['native gardening']
tags = ['weeds', 'invasive species', 'revegetation']
+++
...
### Every little helps
Ideally everything comes out by the roots, leaving nothing behind. That works for Crofton weed, but all weeds are weedy in their own way. [_Asparagus africanus_](https://weeds.dpi.nsw.gov.au/Weed/ClimbingAsparagus) (African asparagus), for example, tends to snap low down on the stem when pulled and has an extensive tangled root system.

I don't beat myself up about it. Every little helps. Every flower removed is one less fruit or seed. Every leaf removed is less sugar for growth. That last one is important; since the leaves feed the roots, a patch of weeds often just "gives up and dies" if leaves are removed as they appear. For larger problems - the evil [_Senna pendula_](https://weeds.dpi.nsw.gov.au/Weed/Cassia) or somewhat less evil [_Ochna serrulata_](https://weeds.dpi.nsw.gov.au/Weed/Ochna) (Mickey mouse plant - no laughing matter) for example, it's perfectly acceptable to chop off the stems and return later, when you have more time and/or energy, with a mattock for the roots.

Every weed that doesn't grow is space and nutrients for something else. Take this patch of [_Veronica plebeia_](https://bie.ala.org.au/species/https://id.biodiversity.org.au/node/apni/2911551) (Australian speedwell), for example:

![Veronica plebeia](/images/speedwell.jpg)
...
For many years I thought that the sum total of native species in my backyard was seven trees: two large [_Eucalyptus grandis_](https://bie.ala.org.au/species/https://id.biodiversity.org.au/taxon/apni/51439812) (flooded gum), probably planted when the house was built; three [_Angophora costata_](https://bie.ala.org.au/species/https://id.biodiversity.org.au/taxon/apni/51439559) (Sydney red gum), one [_Acacia fimbriata_](https://bie.ala.org.au/species/https://id.biodiversity.org.au/taxon/apni/51770526) (Brisbane wattle) and one [_Acacia floribunda_](https://bie.ala.org.au/species/https://id.biodiversity.org.au/node/apni/2916159) (gossamer wattle).

On closer inspection however, there were _endemic_ (that is, local to the area) species just waiting for a chance. Hidden in the tangled stems of an unidentified exotic with pink flowers: [_Lomatia silaifolia_](https://bie.ala.org.au/species/https://id.biodiversity.org.au/node/apni/2897191) (crinkly bush). 

![crinkle bush](/images/crinkle_bush.jpg)

Tangled in long grass and resembling several types of weed but in fact none of them: [_Commelina cyanea_](https://bie.ala.org.au/species/https://id.biodiversity.org.au/node/apni/2907916) (scurvy weed). The aforementioned _Veronica plebeia_ crops up in various places. And down in the lawn at the bottom of the yard: [_Lobelia purpurascens_](https://bie.ala.org.au/species/https://id.biodiversity.org.au/node/apni/2887455) (whiteroot).

All of these, once identified, can be encouraged and cultivated by removing their weedy competitors. Here, for example, is _Lobelia purpurascens_ working hard to fill the space where grass has been removed.

![Lobelia purpurascens](/images/whiteroot.jpg)
...
![Bush boundary](/images/boundary.jpg)

Garden escapes: large Azalea bushes, _Senna pendula_ (did I mention that one is evil?), African asparagus, _Nandina domestica_ (heavenly bamboo - it really isn't) and the purple menace [_Jacaranda mimosifolia_](https://thetawnyfrogmouth.com.au/purple-makes-me-see-red/). Yet just beyond this strip: genuine Hawkesbury sandstone covered with trees: _Angophora_, _Eucalyptus_, _Acacia_; shrubs: _Banksia_, _Ceratopetalum gummiferum_ (NSW Christmas bush), _Hakea sp._; and groundcovers: _Lomandra longifolia_, _Dianella prunina_, to name just a few.
